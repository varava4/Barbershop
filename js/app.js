 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".swiper")) new swiper_core_Swiper(".testimonials__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
...
***************************************************************************** */
        ...
        var lg_autoplay_min = __webpack_require__(312);
            ...
            galleries.forEach((gallery => {
                galleyItems.push({
                    ...
                    galleryClass: lightgallery_es5(gallery, {
                        plugins: [ lg_thumbnail_min, lg_fullscreen_min, lg_autoplay_min ],
